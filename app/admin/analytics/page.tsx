...
import { ArrowRight, Eye, Users, CalendarDays, FileText, ExternalLink } from 'lucide-react'
...
export default function AdminAnalyticsPage() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      setSummary((summaryData?.[0] as Summary) ?? { total_views: 0, unique_visitors: 0, views_today: 0 })
  ...
  const cards = [
    { label: 'الزيارات', value: summary?.total_views ?? 0, icon: Eye, color: 'text-ember' },
    { label: 'زوار مختلفون', value: summary?.unique_visitors ?? 0, icon: Users, color: 'text-gold' },
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-ink/50 font-tajawal text-sm mb-8">آخر {DAYS_BACK} يوم</p>
